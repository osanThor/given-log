  ...
  return (
    ...
    >
      <Image
        ...
        height={100}
      />
      <div className="absolute z-10 flex items-center justify-center w-full gap-2 px-2 font-bold transition -translate-x-1/2 -translate-y-1/2 text-neutral-300 group-hover:text-white top-1/2 left-1/2 ">
        {type === "prev" && (
